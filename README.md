...
🛠 Thành phần hệ thống
Phần cứng (Hardware)
Bộ xử lý trung tâm: Jetson Nano B01 (Xử lý thuật toán điều hướng và dữ liệu LiDAR).

Bộ điều khiển động cơ: STM32F405RGT6 (Quản lý tốc độ, vị trí và phản hồi từ Encoder).

Cảm biến chính: LiDAR A1M8 (Quét 360 độ môi trường xung quanh).
